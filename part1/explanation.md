...
2. SKU uniqueness not enforced: There is no check to ensure SKU is unique across the
platform.
• Impact: Duplicate SKUs break product identification, reporting, and integrations.

3. Product–warehouse modeling is incorrect: Product is created with a single warehouse id,
